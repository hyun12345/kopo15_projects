...
<HTML>
<HEAD>
<title>*Drop twice_stock table</title>
</HEAD>
<BODY>
<h1>Drop table</h1>
...
<%
try{
k15_stmt.execute("drop table twice_stock;");
out.println("twice_stock 테이블 삭제를 완료하였습니다<br>");
}catch(Exception e) {
    out.println("twice_stock 테이블을 삭제할 수 없습니다.<br>");
}
%>